	...
	function()
		...
		it(
			...
			function()
				...
				assert.equal(typeof(instance.Transparency), "number")
		...
		describe(
			...
			function()
				it(
					"should return (0, 0) when it is not a child of ScreenGui",
					function()
				...
				it(
					"should propagate position from a ScreenGui",
					function()
		...
		describe(
			...
			function()
				...
				it(
					"should propagate size from a ScreenGui",
					function()
						local screenGui = ScreenGui:new()
						local screenGuiSize = screenGui.AbsoluteSize
