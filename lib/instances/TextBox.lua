...
TextBox.properties.ClearTextOnFocus =
...
TextBox.properties.ShowNativeInput =
	InstanceProperty.typed(
	"boolean",
	{
		getDefault = function()
...
TextBox.properties.TextTransparency =
	InstanceProperty.typed(
	"number",
	{
		getDefault = function()
...
TextBox.properties.TextTruncate =
	InstanceProperty.enum(
	TextTruncate,
	{
		getDefault = function()
...
TextBox.properties.TextWrapped =
	InstanceProperty.typed(
	"boolean",
	{
		getDefault = function()
...
TextBox.properties.TextXAlignment =
	InstanceProperty.enum(
	TextXAlignment,
	{
		getDefault = function()
...
TextBox.properties.TextYAlignment =
	InstanceProperty.enum(
	TextYAlignment,
	{
		getDefault = function()
...
TextBox.properties.TextEditable =
	InstanceProperty.typed(
	"boolean",
	{
		getDefault = function()
